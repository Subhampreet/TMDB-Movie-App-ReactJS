...
export function Home() {
  ...
  const movies = nowPlaying.slice(0, 5).map((item, index) => {
    return (
      <div style={{ height: 500, width: "100%" }} key={index} className="home">
        ...
        <div
          ...
          style={{ textAlign: "center", fontSize: 55 }}
        >
          {item.title}
        </div>
      </div>
  ...
  const genreList = genres.map((item, index) => {
    return (
      <li className="list-inline-item genreList" key={index}>
        <button
          type="button"
  ...
  const movieList = movieByGenre.slice(0, 4).map((item, index) => {
    return (
      <div className="col-md-3 col-sm-6 movieList" key={index}>
        <div className="card">
        ...
        <div className="mt-3">
          <p style={{ fontWeight: "bolder" }} className="movieTitle" >{item.title}</p>
    ...
    return (
      ...
      <div className="col-md-3 text-center " key={i}>
        <img
          ...
          alt={p.name}
        ></img>
        <p className="font-weight-bold text-center mt-3">{p.name}</p>
        <p
  ...
  return (
    <div className="container">
      ...
      <div className="row mt-3">
        <div className="col">
          <ul className="list-inline genre-list">{genreList}</ul>
        </div>
      </div>
      ...
      <div className="row mt-3 mb-5 footer-text">
